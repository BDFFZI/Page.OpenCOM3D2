...
const MenuItem = {
    ...
    page: () => {
            ...
            },
            {
                ...
                content:
                    <div>
                        ...
                        <br />
                        <ButtonLink type="link" href="https://www.bilibili.com/video/BV1pk4y1E7DJ/" block>视频教程</ButtonLink>
                    </div>
            },
            {
        ...
        return <div>
            ...
            <Card
                title="V3版（旧版，无需CMI）"
                extra={<ButtonLink href="https://mod.3dmgame.com/mod/205515" >下载</ButtonLink>}
                style={{ width: 600 }}
            >
                ...
                <Divider></Divider>
                关于Sybaris加载器，我是从这个翻译插件的<a href="https://github.com/ghorsington/CM3D2.YATranslator/wiki/Installation" target="_blank" rel="noreferrer">安装手册</a>里下载到的。
            </Card>
